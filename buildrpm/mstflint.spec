...
BuildRequires: libibmad-devel >= %{epoch}:2.0.0-1.0.1
...
%changelog
* Thu Aug 02 2018 Aron Silverton <aron.silverton@oracle.com> - 0:4.10.0-2.0.1
- Reconfigure for Oracle's build system (Aron Silverton) [Orabug: XXXXXXXX]
